var shopSenseApp = angular.module('shopSenseApp', ['ngRoute', 'firebase']);
 ...
 shopSenseApp.controller('ChatCtrl', ['$scope', '$firebase',
        function($scope, $firebase) {
        	...
        	// .set will create this object in the child 'user' replacing any object that was there.
	      	/*var usersRef = ref.child("users");
			usersRef.set({
			  Iwanisawesome: {
			    date_of_birth: "February 8, 1975",
			    full_name: "Iwan Ruslani"
			  },
			  Dylanisgreat: {
			    date_of_birth: "December 13, 2008",
			    full_name: "Dylan Rael"
			  }
			});

			// . update will update it and not replace or set the object to this new value.
			var dylanRef = usersRef.child("Dylanisgreat");
			dylanRef.update({
			  "nickname": "Booobooo"
			});

			// Using .push will update the object and give each object a unique key. 
			var postsRef = ref.child("posts");
			  postsRef.push({
			    author: "Iwanisawesome",
